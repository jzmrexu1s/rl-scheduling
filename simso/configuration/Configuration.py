...
from simso.core.Task import MCTaskInfo, TaskInfo
...
class Configuration(object):
    ...
    def add_task(self, name, identifier, task_type="Periodic",
                 ...
                 list_activation_dates=[], preemption_cost=0, data=None, wcet_high=0, criticality="LO", deadline_offset=0):
        """
        ...
        if self.mc:
            task = MCTaskInfo(name, identifier, task_type, abort_on_miss, period,
                            ...
                            preemption_cost, data, wcet_high, criticality, deadline_offset)
        else:
